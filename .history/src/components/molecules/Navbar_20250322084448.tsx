              ...
              <Popover>
                <PopoverTrigger>
                  <Button
                    ...
                    bgPosition="center"
                    _hover={{
                      bgImage: "url('/logo.png')", // Giữ nguyên hình nền khi hover
                      opacity: 0.9, // Tùy chọn: thêm hiệu ứng mờ nhẹ
                      transform: "scale(1.05)", // Tùy chọn: phóng to nhẹ khi hover
                    }}
                    borderColor="gray.200"
                    _active={{
                      bgImage: "url('/logo.png')", // Giữ nguyên hình nền khi click
                      transform: "scale(0.98)", // Tùy chọn: hiệu ứng nhấn xuống khi click
                    }}
                  />
                </PopoverTrigger>
