    ...
    <>
      ...
      <Container maxW="container.xl" py={12}>
        <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} spacing={10}>
          {data?.allKhachSan?.nodes?.[0]?.cardZones?.roomCardChild?.map((room: any, index: number) => (
          <Card
              key={index}
          ...
          >
            <CardBody p={0} position="relative" borderRadius={10}>
              <Box position="relative" h="250px">
                <Image
                  borderTopRadius={10}
                    src={room?.cardContent?.images?.[0] || "/quanCafe.jpg"}
              ...
              >
                ...
                <Text fontSize="md" color="gray.600" mb={3}>
                    {room?.cardContent?.time || "2 Day 1 Night"} For {room?.cardContent?.people || "2"} Pax
                </Text>
