                  ...
                  >
                    ...
                    <Box>
                      ...
                      <HStack spacing={2} justify="start">
                        {room?.cardContent?.photos?.slice(0, 3).map((photo: any, photoIndex: number) => (
                          <Box key={photoIndex} width="80px" height="60px" overflow="hidden" borderRadius="md" flexShrink={0}>
                            <Image
