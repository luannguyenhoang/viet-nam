        ...
        >
          <CardBody p={0} position="relative" borderRadius={10}>
            <Box position="relative" h="250px">
              <Image
                borderTopRadius={10}
                src={room?.cardContent?.image?.node?.mediaItemUrl || "/quanCafe.jpg"}
            ...
            >
              ...
              <Text fontSize="md" color="gray.600" mb={3}>
                {room?.cardContent?.time || "2 Day 1 Night"} For{" "}
                {room?.cardContent?.people || "2"} Pax
              </Text>
              ...
              <Box>
                ...
                <HStack justify="space-between" spacing={2}>
                  {room?.cardContent?.photos?.child?.slice(0, 3)?.map(
