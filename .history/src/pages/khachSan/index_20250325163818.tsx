...
export default function KhachSan() {
  ...
  return (
    <>
      <Metadata 
        title="Đặt Phòng Khách Sạn | Luxury Stay" 
        description="Đặt phòng khách sạn cao cấp với giá tốt nhất"
      />

      {/* Hero Section */}
      <div className="relative h-[80vh] bg-cover bg-center" style={{backgroundImage: "url('/images/hotel-hero.jpg')"}}>
        <div className="absolute inset-0 bg-black/50" />
        <div className="relative z-10 h-full flex items-center justify-center text-white text-center px-4">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Trải Nghiệm Đẳng Cấp Tại Khách Sạn Của Chúng Tôi</h1>
            <p className="text-xl">Khám phá không gian sang trọng và dịch vụ đẳng cấp 5 sao</p>
          </div>
        </div>
      </div>
