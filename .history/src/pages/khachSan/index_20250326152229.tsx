              ...
              <VStack spacing={6} color="white" textAlign="center" w="full">
                ...
                >
                  <VStack spacing={6} w="full">
                    <Tabs variant="soft-rounded" colorScheme="blue" width="full" isFitted>
                      <TabList mb={4}>
                        <Tab fontWeight="medium">Khách sạn</Tab>
                        <Tab fontWeight="medium">Resort</Tab>
                        <Tab fontWeight="medium">Homestay</Tab>
                      </TabList>
                    </Tabs>
