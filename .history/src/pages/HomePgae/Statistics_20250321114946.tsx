...
// Cập nhật dữ liệu cho từng card để sử dụng từng banner khác nhau
const cardData = [
  { icon: FaUmbrellaBeach, banner: "banner_1" },
  { icon: FaPlane, banner: "banner_2" },
  { icon: FaHotel, banner: "banner_3" },
];
