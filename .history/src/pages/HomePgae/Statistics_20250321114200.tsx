...
const cardData = [
  { icon: FaUmbrellaBeach, title: "title_1", stat: "title_1" },
  { icon: FaPlane, title: "title_1", stat: "title_2" },
  { icon: FaHotel, title: "title_1", stat: "title_2" },
];
      ...
      <Box maxW="7xl" mx={"auto"} py={40} px={{ base: 2, sm: 12, md: 17 }}>
        ...
        <SimpleGrid columns={{ base: 1, md: 3 }} spacing={{ base: 5, lg: 8 }}>
          {cardData.map((item, index) => (
            <StatsCard
              key={index}
              title={session4?.banner_1[item.title as keyof BannerItem]}
              stat={session4?.banner_1[item.stat as keyof BannerItem]}
