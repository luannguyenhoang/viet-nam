...
import type { AmThuc } from "@/type/types";
import {
  Box,
  Button,
  Card,
...
export default function Containers({ amThucData }: { amThucData: AmThuc[] }) {
    ...
    <Box bgGradient={bgGradient} pt={24} pb={16}>
      <Container maxW="container.xl">
        <Box
          ...
          overflow="hidden"
          position="relative"
          backgroundImage={amThucData[0]?.image || "url('/images/vietnamese-food-banner.jpg')"}
