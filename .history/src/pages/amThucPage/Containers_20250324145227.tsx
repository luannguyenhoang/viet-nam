...
import { Box, Button, Card, CardBody, Heading, Image, SimpleGrid, Stack, TabPanel, TabPanels, Text, useColorModeValue } from '@chakra-ui/react'
import React from 'react'

export default function Containers({ session2 }: { session2: any }) {
