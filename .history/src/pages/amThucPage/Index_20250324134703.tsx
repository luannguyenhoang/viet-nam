  ...
  const featuredDishes = {
    ...
    "mien-nam": [
      ...
      },
      {
        ...
        description: "Cơm gạo tấm với sườn nướng, bì, chả trứng và nước mắm ngọt đặc trưng.",
      },
      {
        id: 9,
        name: "Bánh Tét",
        image: "/images/banh-tet.jpg",
        description: "Bánh gạo nếp nhân đậu xanh và thịt heo, gói bằng lá chuối.",
      },
    ],
  };
          ...
          >
            ...
            >
              ...
              <Text fontSize="xl" maxW="800px">
                Khám phá nét đặc sắc trong ẩm thực ba miền Bắc - Trung - Nam với những món ăn đậm đà hương vị quê hương
              </Text>
            </Flex>
          </Box>
            ...
            <TabPanels>
              {foodCategories.map((category) => (
                <TabPanel key={category.slug}>
                  <Box mb={10}>
                    <Heading size="lg" mb={6} textAlign="center" color={category.color}>
                      Đặc Sản {category.name}
                    </Heading>
                    
                
                    <SimpleGrid columns={{ base: 1, md: 3 }} spacing={8} mb={12}>
                      {featuredDishes[category.slug as keyof typeof featuredDishes].map((dish) => (
                        <Card 
                          key={dish.id} 
                          overflow="hidden"
                          variant="outline"
                        ...
                        >
                          ...
                          <CardBody>
                            <Stack spacing={3}>
                              ...
                              <Button colorScheme="red" size="sm" width="fit-content">
                                Xem chi tiết
                              </Button>
                            </Stack>
                          </CardBody>
