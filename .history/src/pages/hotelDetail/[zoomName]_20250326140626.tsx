          ...
          <VStack spacing={4} height="100%">
            ...
            >
              <HStack justify="space-between" mb={4}>
                ...
                {calculateDiscountPercentage( parseVietnamCurrency(data.maxPrice),  parseVietnamCurrency(data.minPrice)) > 0 && (
                  <Badge colorScheme="green" fontSize="lg" p={2}>
                    -{calculateDiscountPercentage( parseVietnamCurrency(data.maxxPrice),  parseVietnamCurrency(data.minPrice))}%
                  </Badge>
                )}
              </HStack>
