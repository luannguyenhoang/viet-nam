              ...
              <VStack spacing={6} width="100%" divider={<Divider />}>
                <Box width="100%">
                  ...
                  <Text>
                    ...
                    viên rất nhiệt tình và chuyên nghiệp. Bữa sáng đa dạng và
                    ngon miệng. Tôi sẽ quay lại trong kỳ nghỉ tiếp theo!
                  </Text>
                </Box>
                ...
                <Box width="100%">
                  ...
                  <Text>
                    ...
                    chỉ mất 5 phút. Tuy nhiên, WiFi hơi chậm vào buổi tối. Dịch
                    vụ nhà hàng khá tốt, thức ăn ngon miệng.
                  </Text>
                </Box>
              </VStack>
                  ...
                  <ListItem>
                    <HStack align="start">
                      ...
                      <Box>
                        ...
                        <Text>
                          Trẻ em dưới 5 tuổi được ở miễn phí khi sử dụng giường
                          có sẵn. Trẻ từ 6 tuổi trở lên được tính như người lớn.
                        </Text>
                      </Box>
                    </HStack>
                  </ListItem>
                  <ListItem>
                    <HStack align="start">
                      ...
                      <Box>
                        ...
                        <Text>
                          Đây là phòng không hút thuốc. Phí phạt 1.000.000 VND
                          nếu vi phạm.
                        </Text>
                      </Box>
                    </HStack>
              ...
              <Box>
                ...
                <Box mt={8}>
                  ...
                  <HStack spacing={4} mt={2}>
                    <Image src="" alt="Visa" height="30px" />
                    <Image
                      src="g"
                      alt="Mastercard"
                      height="30px"
                    />
                    <Image src="/" alt="JCB" height="30px" />
                    <Image src="/" alt="MoMo" height="30px" />
                  </HStack>
                </Box>
              </Box>
            </SimpleGrid>
