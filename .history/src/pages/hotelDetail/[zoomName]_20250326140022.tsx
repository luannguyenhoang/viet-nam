...
import { parseVietnamCurrency, calculateDiscountPercentage } from "@/utils/common";
...
export default function HotelDetail() {
  ...
  // Hàm chuyển đổi chuỗi định dạng số Việt Nam sang số
  const parseVietnamCurrency = (currencyString: string) => {
  ...
  // Trong phần render
  const maxPrice = parseVietnamCurrency(data.maxPrice);
  const minPrice = parseVietnamCurrency(data.minPrice);
  const discountPercentage = calculateDiscountPercentage(maxPrice, minPrice);
