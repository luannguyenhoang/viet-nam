...
export default function SlideConten({
  ...
  // Fetch all cursors for pagination on component mount
  useEffect(() => {
...
// Extracted Post Card component for better organization
function PostCard({ post, isHorizontal }: { post: Post; isHorizontal: boolean }) {
